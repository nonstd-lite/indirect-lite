...
CASE( "indirect-value-lite configuration" "[.scope][.config]" )
{
    ...
    nsiv_PRESENT( nsiv_CONFIG_NO_EXTENSION_VALUE_MEMBERS );
    nsiv_PRESENT( nsiv_CONFIG_NO_EXTENSION_GET_CPY_DEL_MEMBERS );
    nsiv_PRESENT( nsiv_CONFIG_NO_EXTENSION_RELATIONAL_OPERATORS );
    nsiv_PRESENT( nsiv_CONFIG_NO_EXTENSION_STD_HASH );
