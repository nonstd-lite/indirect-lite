...
set unit_config=^
    ...
    -Dnsiv_INDIRECT_HEADER=\"nonstd/indirect.hpp\"
...
::    -Dnsiv_CONFIG_NO_EXCEPTIONS=1
::    -Dnsiv_CONFIG_STD_SV_OPERATOR=1
::    -Dnsiv_CONFIG_CONVERSION_STD_STRING=1
::    -Dnsiv_CONFIG_CONVERSION_STD_STRING_CLASS_METHODS=1
::    -Dnsiv_CONFIG_CONVERSION_STD_STRING_FREE_FUNCTIONS=1
::    -Dnsiv_CONFIG_NO_STREAM_INSERTION=1
